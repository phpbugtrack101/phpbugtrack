...
define ('DB_PORT', ''); // hostname of database server
...
define ('TBL_PREFIX', 'phpbt_');	// the prefix for all tables, leave empty to use the old style
...
define('SMTP_AUTH_USER', "amaron9082@gmail.com");
define('SMTP_AUTH_PASS', "dronathefilm");
